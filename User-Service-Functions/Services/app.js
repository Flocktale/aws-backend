...
const { UserBaseCompleteSchema } = require('../../Database-Schemas/UserBase');
const { FollowRequestSchemaWithDatabaseKeys } = require('../../Database-Schemas/FollowRequest');
const { FollowingSchemaWithDatabaseKeys } = require('../../Database-Schemas/Following');
const { FollowerSchemaWithDatabaseKeys } = require('../../Database-Schemas/Follower');
...
// send a follow-request
app.post('/users/:userId/follow-requests', (req, res) => {
...
app.delete('users/:userId/follow-requests/sent', (req, res) => {
...
//     try {
//         const _schema = Joi.string().valid('accept', 'cancel').required();
//         const result = await _schema.validateAsync(abcd);
//         console.log(result);
//     } catch (e) {

//         console.log('Invalid Response action to follow request (accept/cancel)');
//     }
// }
